...
function nuevoUsuario(nombre, email, password) {
  ...
  // Devuelve el objeto
  // Tu código:
var nuevoobjetoo ={nombre:nombre, email:email, password:password}
return nuevoobjetoo
}
...
if(usuario.email !== null) { // tercer caso undefined
  return true;
}  
return false
...
function sumarLikesDeUsuario(usuario) {
  ...
  // Devuelve la suma   usuario = {posts : []  }
  // Tu código:
  var sumar=0
  for(var i=0; 0 <usuario.posts.length; i++) {
